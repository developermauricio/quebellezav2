...
function wc_price( $price, $args = array() ) {
	...
	echo '<div class="precios-mayoristas">';
	the_field('moneda');
	echo ' <span class="formar">';
	the_field( 'precio_detal');
	echo '</span> <span class="precio">';
	the_field('etiqueta_detal');
	echo '</span></div><div class="precios-mayoristas">';
	the_field('moneda');
	echo ' ';
	the_field('precio_mayorista');
	echo ' <span class="precio">';
	the_field('etiqueta_mayorista' );
	echo '</span></div><div class="precios-mayoristas">';
	the_field('moneda');
	echo ' ';
		format_number(the_field('precio_gran_mayorista');
		echo ' <span class="precio">';
	the_field('etiqueta_gran_mayorista' );
